...
- 1. CV or Resume (Curriculum Vitae/Resume) : 이력서
- 2. SOP (Statement of Purpose) : 연구계획서
- 3. PS (Personal Statement) : 자기소개서
- 4. 3 Letters of Recommendation : 추천서
- 5. 그 외 서류: Transcripts (성적증명서,졸업증명서), 영어 점수 (GRE, 토플), 학교별로 추가로 요구하는 List of Relevant Courses, Scholaro Self-Reported GPA, Fellowship Application 등의 서류
