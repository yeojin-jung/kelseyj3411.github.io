...
종종 지랄이라고도 불리는 지알이는 토플에 비해 난이도가 매우 높습니다. 그래서 높은 점수를 목표로 하지 않아도 학원을 다녀야 하고 시간을 많이 투자해야 합니다. 저는 학원을 한 달 다니고 바로 시험을 보기에는 어휘가 부족하다고 느껴서 한 달을 추가로 독학했습니다. 정말 이 시기에는 지랄이 말고 아무것도...못했습니다. 가능하면 방학을 이용해 지알이를 공부하는걸 추천드립니다. 지알이는 <mark style='background-color: #d0ebff'> Verbal Reasoning / Quantitative Reasoning / Analytical Writing </mark> 세 가지 섹션으로 나뉩니다. Writing의 두 유형을 각각 30분동안 풀고 Verbal/Quant를 교대로 총 5섹션을 봅니다. 이 중에 한 섹션은 더미입니다. Verbal은 섹션 당 30분, Quant는 35분입니다. 시험 순서의 예시는 아래와 같습니다. 만약에 2번째처럼 퀀트 더미가 나온다면 개꿀이라고 생각하면 됩니다.
...
박사의 경우 <font color='#f06595'> 펀딩 </font>은 무조건 나옵니다. 학비는 일단 학교에서 100퍼센트 다 지원해줍니다. 이제 stipend(생활비)를 얼마냐 받냐에 따라 펀딩 규모가 달라지는데, 주립대학교보다 아이비학교들이 돈을 더 많이 주고 물가가 비싼 뉴욕이나 캘리포니아 쪽 학교들은 지원을 더 많이 해줍니다. 대부분 월급 기준 2500~3000 달러 사이로 stipend를 지원해줍니다. 사치를 부리지 않는다면 렌트까지 포함해서 이 정도의 생활비로 충분히 살 수 있지만, 더 돈이 필요하다면 펀딩에 대한 내용을 홈페이지에서 찾아서 읽어보고 추후 학교를 선택할 때 고려할 수 있습니다.
...
저는 제 연구 분야의 연장선으로 functional data analysis를 하시는 교수님 위주로 서치를 했고 더 넓게 나아가 high-dimensional inference를 하시는 분들도 서치를 했습니다. 어떤 학교는 통계학의 여러 하위 학문별로 연구소가 있기도 합니다. 또한 막연하게 application 쪽은 바이오 쪽이 재밌을 것 같아서 학과에 fda와 바이오 데이터 쪽을 같이 하시는 교수님이 있는지도 체크했던 것 같습니다. 
...
- 지원 특이사항 (성적 변환 방법, GMAT 요구 등, 4탄에서 자세히 설명 예정)
- 학과 주력 연구 / 스타일
- 관심 연구 분야 교수진
- 펀딩 규모
