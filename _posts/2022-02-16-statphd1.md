...
이제 엑셀 파일에 지원할 학교 리스트를 작성하고 위의 서치한 정보를 넣으시면 됩니다. 저는 일단 US News 랭킹 순으로 1~40위까지의 학교들을 리스트에 넣고 정보 수집을 하며 소거법으로 지원하지 않을 학교들은 제외했습니다. 
