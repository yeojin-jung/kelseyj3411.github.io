...
- <mark style='background-color: #d0ebff'> 같은 학교 출신 선배가 있는 학교는 무조건 써라 </mark>: 제가 어드미션을 받은 곳이나 인터뷰 / 대기를 받은 학교 대부분은 연대 통데싸 출신 선배가 재학 중인 곳이었습니다 (NC State, PennState, OSU, Wisconsin-Madison, Duke(Biostat), Purdue, UIUC). 미국 박사 어드미션의 경우 입학처에 어떤 교수님이 있냐에 따라 한국인 학생의 합불이 크게 영향을 받는데 만약 교수님이 한국인이거나 / 그 학과에 잘하는 학생이 같은 학교 출신이라면 유리합니다. 
- <mark style='background-color: #d0ebff'> 최대한 많이 써라 </mark>: 일반적으로 저희 학교 기준 학생들은 박사과정을 지원할 때 20군데 이상의 학교에 지원합니다. 저는 원래 30군데에 지원하려 했으나 중간중간 데드라인 까먹음, 복잡한 지원 과정에 탈주, 여기는 써도 안될 것 같아서 탈주 등등으로 23군데를 최종적으로 지원했습니다. 당연히 학교를 많이 지원할 수록 어드미션을 한군데라도 받을 확률은 증가합니다.
- <mark style='background-color: #d0ebff'> 규모가 큰 주립대학교를 노리자 </mark>: 주립대학교는 아무래도 사립대학교나 아이비보다 외국인 학생들에게 열려있고 실제로 공부하고 있는 한국인 선배님들도 많습니다. 또한 학과 규모가 크기 때문에 어드미션도 많이 줍니다.
