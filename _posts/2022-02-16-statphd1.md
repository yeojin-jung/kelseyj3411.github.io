...
현재까지 나온 지원 결과들을 종합해보자면 최종적으로 어드미션을 받은 곳은 <mark style='background-color: #d0ebff'> UChicago, NC State, PennState, OSU, Cornell </mark> 이렇게 5군데이고, 인터뷰는 Duke(Biostat, 공식 인터뷰), Purdue(비공식 인터뷰), UIUC(거절), 마지막으로 대기를 받은 곳은 Wisconsin-Madison과 UMich(Biostat)입니다. 

---

## 참고 사이트
- [SOPHAS](https://sophas.org/) (Biostat 지원 플랫폼)
- [GRE 중국 기출](https://gre.kmf.com/)
...
종종 지랄이라고도 불리는 지알이는 토플에 비해 난이도가 매우 높습니다. 그래서 높은 점수를 목표로 하지 않아도 학원을 다녀야 하고 시간을 많이 투자해야 합니다. 저는 학원을 한 달 다니고 바로 시험을 보기에는 어휘가 부족하다고 느껴서 한 달을 추가로 독학했습니다. 정말 이 시기에는 지랄이 말고 아무것도...못했습니다. 가능하면 방학을 이용해 지알이를 공부하는걸 추천드립니다. 지알이는 <mark style='background-color: #d0ebff'> Verbal Reasoning / Quantitative Reasoning / Analytical Writing </mark> 세 가지 섹션으로 나뉩니다. Writing의 두 유형을 각각 30분동안 풀고 Verbal/Quant를 교대로 총 5섹션을 봅니다. 이 중에 한 섹션은 더미입니다. 4섹션만 봐도 힘들어 죽겠는데 더미는 왜 보는지 모르겠습니다:no_good:. Verbal은 섹션 당 30분, Quant는 35분입니다. 시험 순서의 예시는 아래와 같습니다. 만약에 2번째처럼 퀀트 더미가 나온다면 개꿀이라고 생각하면 됩니다.

- Writing/Issue - Writing/Argue - Verbal - Quant - 10 minute Break - Verbal - Quant - Verbal
- Writing/Issue - Writing/Argue - Quant - Verbal - 10 minute Break - Quant - Verbal - Quant
...
자신에게 맞는 학교를 선택할 때 고려할 수 있는 요소는 <mark style='background-color: #d0ebff'> 랭킹 / 연구 분야 (교수진) / 펀딩 규모 / 지역 / 기후 </mark>가 있습니다. <font color='#f06595'> 랭킹 </font>이 높을수록 인지도나 네트워크 측면에서는 좋겠지만 꼭 높은 랭킹이 무조건적으로 더 수준 높은 교육/교수진을 뜻하지는 않습니다. 따라서 랭킹이 5위 이상 차이가 나지 않는다면, 박사는 지도교수가 매우 중요하기 때문에 <mark style='background-color: #d0ebff'> 자신의 연구 분야와 잘 맞는 교수님이 있는 학과를 선택하는 것이 중요하다고 생각합니다. </mark> 학교의 랭킹은 [US News](https://www.usnews.com/best-graduate-schools/top-science-schools/statistics-rankings)를 참고하면 됩니다. 

박사의 경우 <font color='#f06595'> 펀딩 </font>은 무조건 나옵니다. 학비는 일단 학교에서 100퍼센트 다 지원해줍니다. 이제 stipend(생활비)를 얼마냐 받냐에 따라 펀딩 규모가 달라지는데, 주립대학교보다 Ivy 학교들이 돈을 더 많이 주고 물가가 비싼 뉴욕이나 캘리포니아 쪽 학교들은 지원을 더 많이 해줍니다. 대부분 월급 기준 2500~3000 달러 사이로 stipend를 지원해줍니다. 사치를 부리지 않는다면 렌트까지 포함해서 이 정도의 생활비로 충분히 살 수 있지만, 더 돈이 필요하다면 펀딩에 대한 내용을 홈페이지에서 찾아서 읽어보고 추후 학교를 선택할 때 고려할 수 있습니다.

사실 학교 서치 과정에서 가장 중요한 부분은 <font color='#f06595'> 관심 연구 분야 </font> 교수님을 찾기인데요, <mark style='background-color: #ffdeeb'> 자신이 관심 있는 연구분야와 그 학교 교수님의 연구분야의 핏이 생각보다 어드미션 과정에 중요하게 작용하기 때문입니다. 이를 후에 SOP에 녹여내야 합니다. </mark> 미국 대학교에서 근무하시는 제 친구 부모님께 여쭤봤을 때도 그렇고, 인터뷰 때 교수님들에게 여쭤봤을 때도 학생이 아무리 뛰어나도 관심 연구 분야를 하는 교수님이 학교에 한 명도 없으면 뽑지 않을 것 같다고 말했습니다. 따라서 학교 서치를 하기 전 자신의 <mark style='background-color: #d0ebff'> 대략적인 관심 연구분야 </mark>는 미리 생각을 해두는 것이 좋습니다. 실제로 학교 서치를 하면서 여러 교수님의 프로필과 논문을 보며 관심 분야가 구체화되는 경우도 있으니, 지금 당장 관심 연구 분야가 구체적으로 없더라도 걱정하지 마세요!:hatched_chick:


### 꼭 필요한 정보 수집

저는 제 연구 분야의 연장선으로 functional data analysis를 하시는 교수님 위주로 서치를 했고 더 넓게 나아가 high-dimensional inference를 하시는 분들도 서치를 했습니다. 어떤 학교는 통계학의 여러 하위 학문 별로 연구소가 있기도 합니다. 또한 막연하게 application 쪽은 바이오 쪽이 재밌을 것 같아서 학과에 fda와 바이오 데이터 쪽을 같이 하시는 교수님이 있는지도 체크했던 것 같습니다. 

또한 같은 통계학과라고 해도 어떤 학교들은 이론과 수학을 더 강조하고 (Columbia, UChicago, JHU 등등) 어떤 학교들은 프로그래밍과 응용을 더 강조합니다 (Stanford, CMU, UC Berkely, Yale 등등). 베이지안에 관심이 있다면 유구한 역사를 가진 Duke 대학도 있습니다. 이런 학교의 스타일은 홈페이지를 자세하게 살펴보거나 선배들(me)에게 물어보면 잘 알려줍니다. 이 학교 서치 과정이 워낙 길고 힘들기 때문에 <mark style='background-color: #d0ebff'> 한 번에 학교 서치할 때 필요한 정보를 다 정리하는 것이 좋습니다. </mark> 필수적인 정보는,

- 지원 데드라인
- 지원 비용
- 위치
- GRE / TOEFL 코드 (후에 성적 발송 할 때 필요함)
- GRE / TOEFL 영역별 minimum
- 필요 지원 서류 (SOP, CV, PS 외의 추가 서류, 2탄에서 자세히 설명 예정)
- 지원 특이사항 (성적 변환 방법, GMAT 요구 등, 2탄에서 자세히 설명 예정)
- 학과 주력 연구 / 스타일
- 관심 연구 분야 교수진
- 펀딩 규모
...
이제 엑셀 파일에 지원할 학교 리스트를 작성하고 위에서 서치한 정보를 칼럼으로 넣으시면 됩니다. 저는 일단 US News 랭킹 순으로 1~50위까지의 학교들을 리스트에 일단 다 넣고 정보 수집을 하며 소거법으로 지원하지 않을 학교들은 제외했습니다. 추가로 교수님과 교수님 연구 분야에 대한 정보는 엑셀에 넣기 애매해서 별도의 워드 파일을 파서 정리했습니다. 

최대한 한 곳이라도 어드미션을 받기 위한 전략은 다음과 같습니다.

- <mark style='background-color: #c3fae8'> 같은 학교 출신 선배가 있는 학교는 무조건 써라 </mark>: 제가 어드미션을 받은 곳이나 인터뷰 / 대기를 받은 학교 대부분은 연대 통데싸 출신 선배가 재학 중인 곳이었습니다 (NC State, PennState, OSU, Wisconsin-Madison, Duke(Biostat), Purdue, UIUC). 미국 박사 어드미션의 경우 입학처에 어떤 교수님이 있냐에 따라 한국인 학생의 합불이 크게 영향을 받는데 만약 교수님이 한국인이거나 / 그 학과에 잘하는 학생이 같은 학교 출신이라면 유리합니다. 
- <mark style='background-color: #c3fae8'> 최대한 많이 써라 </mark>: 일반적으로 저희 학교 기준 학생들은 박사과정을 지원할 때 20군데 이상의 학교에 지원합니다. 저는 원래 30군데에 지원하려 했으나 중간중간 데드라인 까먹음, 복잡한 지원 과정에 탈주, 여기는 써도 안될 것 같아서 탈주 등등으로 23군데를 최종적으로 지원했습니다. 당연히 학교를 많이 지원할 수록 어드미션을 한군데라도 받을 확률은 증가합니다.
- <mark style='background-color: #c3fae8'> 규모가 큰 주립대학교를 노리자 </mark>: 주립대학교는 아무래도 사립대학교나 아이비보다 외국인 학생들에게 열려있고 실제로 공부하고 있는 한국인 선배님들도 많습니다. 또한 학과 규모가 크기 때문에 어드미션도 많이 줍니다.

이 전략만 잘 따른다면 다들 생각보다 많은 곳에서 어드미션을 받습니다. 저도 비행기 못 뜨면 어떡하냐고 친구들에게 매일 찡찡거렸지만...(얘들아 미안) 올 리젝은 생각도 하지 말고 매 순간 지원 과정에서 최선을 다하면 됩니다.:fire: :fire: 그럼 다음 편에서는 지원 서류 (SOP, CV, 추천서 등)에 관해 상세하게 설명하겠습니다. 
